      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-16">
          <div className="text-center">
            ...
            <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">Mint Unique Tickets</h3>
          ...
          <div className="text-center">
            ...
            <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">Secure Trading</h3>
            <p className="text-gray-600 dark:text-gray-300">
          ...
          <div className="text-center">
            ...
            <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">Decentralized Ownership</h3>
            <p className="text-gray-600 dark:text-gray-300">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 mt-16">
          <h2 className="text-2xl font-bold text-center text-gray-900 dark:text-white mb-8">Platform Statistics</h2>
